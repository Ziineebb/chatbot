...
async function ask() {
    ...
    try {
        ...
        // Append user message with a man icon
        const userMessage = document.createElement('p');
        userMessage.innerHTML = '<i class="fa-solid fa-user"></i> ' + tweet;
        userMessage.setAttribute("class", "userP");
        answerDiv.appendChild(userMessage);
